...
`Réécrire ce paragraphe pour ajouter plus de détails sur le produit. Le ton de ce paragraphe doit être professionnel et engageant.`

## Convertir du texte en tableau

`Ajoute une liste d’jalons de projet et de leurs échéances.`

`Ajouter une troisième colonne, Tâche terminée, à la table.`

## Résumer votre document

`Résumez ce document. Mettez en évidence les trois principaux points.`
